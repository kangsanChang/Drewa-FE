      ...
      <div id="contents-wrapper">
        ...
        <div id="info-wrapper">
            ...
            <div class="buttons" align="center">
                <router-link v-if="this.status === '미제출'" :to="{name: 'application'}" class="button" id="edit-btn">수정</router-link>
                <router-link v-else-if="this.status === ('제출 완료' || '서류 합격')" :to="{name: 'application'}" class="button" id="edit-btn">지원서 확인</router-link>
                <a v-if="this.status === '미제출'" class="button" id="remove-btn" @click="removeConfirm">삭제</a>
            </div>
        </div>
      </div>
  </div>
